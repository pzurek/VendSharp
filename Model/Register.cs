...
namespace Vend
{
	...
	public class Register : BaseApiObject
	{
		...
		public bool PrintRecept { get; set; }
		...
		public bool AskForNoteOnSave { get; set; }
		...
		public bool AskForUserOnSale { get; set; }
		...
		public bool ShowDiscountsOnReceipt { get; set; }
		...
		public bool ReceiptBarcoded { get; set; }
